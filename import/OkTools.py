...
class OkTools:
	...
	@staticmethod
	def manhattanDistance(vec: [float]*3, axis=1, keepdims=False):
		return np.sum(np.abs(vec), keepdims=keepdims, axis=axis) * 0.66666666666666666667

	@staticmethod
	def vec3_arrayNorm(vector_list: NDArray[[float]*3], axis=1):
